...
public class Company extends TableImpl<CompanyRecord> {
    ...
    private static final long serialVersionUID = -2078208297;
     ...
     */
    public final TableField<CompanyRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('company_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
     ...
     */
    public final TableField<CompanyRecord, String> ADDRESS = createField("address", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.company.primary_contact</code>.
     */
    public final TableField<CompanyRecord, Long> PRIMARY_CONTACT = createField("primary_contact", org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>public.company.pricing_details</code>.
     */
    public final TableField<CompanyRecord, Long> PRICING_DETAILS = createField("pricing_details", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
