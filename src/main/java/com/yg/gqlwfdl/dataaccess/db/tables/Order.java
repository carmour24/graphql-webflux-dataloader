...
public class Order extends TableImpl<OrderRecord> {
    ...
    private static final long serialVersionUID = -1069820653;
    ...
    /**
     * The column <code>public.order.customer</code>.
     */
    public final TableField<OrderRecord, Long> CUSTOMER = createField("customer", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.order.date</code>.
     */
    public final TableField<OrderRecord, OffsetDateTime> DATE = createField("date", org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE.nullable(false), this, "");

    /**
     * The column <code>public.order.delivery_address</code>.
     */
    public final TableField<OrderRecord, String> DELIVERY_ADDRESS = createField("delivery_address", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");
